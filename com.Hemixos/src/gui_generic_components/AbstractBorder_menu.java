...
public class AbstractBorder_menu implements Border {

	
	private int epaisseur = 12;
	private Color bg_color = AbstractColors.GUI_MN_BACKGROUND;
	...
	public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
	    ...
	    for (i = 1; i < epaisseur; i++) {
		    ...
		    g.drawLine(x+width-epaisseur+i-1, y, x+width-epaisseur+i-1, y+height);
